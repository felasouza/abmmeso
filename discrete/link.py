...
class Link:
    ...
    def update_state_variables(self, t):
        ...
        self.cap_disc_upstream[t+1] = min(self.cap_disc_upstream[t]-self._inflow+self.cap*self.time_step, math.ceil(self.cap*self.time_step)+1)
        self.cap_disc_downstream[t+1] = min(self.cap_disc_downstream[t]-self._outflow+self.cap*self.time_step, math.ceil(self.cap*self.time_step)+1)
